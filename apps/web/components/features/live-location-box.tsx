...
const LiveLocationIcon = () => (
  ...
  >
    <path
      d="M12.5 3.5C8.63401 3.5 5.5 6.63401 5.5 10.5C5.5 15.5 12.5 21.5 12.5 21.5C12.5 21.5 19.5 15.5 19.5 10.5C19.5 6.63401 16.366 3.5 12.5 3.5Z"
      stroke="currentColor"
      strokeMiterlimit="10"
      ...
      strokeWidth="1.5"
    />
    <circle cx="12.5" cy="10.5" r="2.5" fill="currentColor" />
  </svg>
);

interface LiveLocationBoxProps {
  className?: string;
}

export const LiveLocationBox = ({ className = '' }: LiveLocationBoxProps) => {
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center overflow-hidden">
        <svg
          ...
          fill="none"
          viewBox="0 0 330 430"
          className="w-full h-full max-w-[280px] max-h-[360px] scale-110"
        >
          <g clipPath="url(#a)">
            <mask
              id="c"
            ...
            <g mask="url(#c)">
              ...
              <path
                ...
                stroke="url(#e)"
                strokeWidth=".523"
                d="M96.084 155.412c33.737 11.315 59.645 37.817 73.285 58.961-119.49.257-216.3 97.099-216.507 216.602-24.307-9.556-42.152-23.158-53.506-39.737-11.408-16.659-16.275-36.341-14.544-57.988 3.464-43.304 33.338-94.477 90.097-144.929 45.362-40.322 87.248-44.287 121.175-32.909Z"
              />
            </g>
            <path stroke="#4ade80" strokeWidth=".523" d="M163.815 289.173c5.145-1.641 18.709-5.589 31.803-8.251" />
            <path
              stroke="#4ade80"
              strokeWidth=".63"
              d="M163.743 289.032c-18.206 5.187-43.077 15.647-62.293 26.53-2.857-5.626-8.859-19.013-10.005-27.548"
              opacity=".6"
            />
            <path
              stroke="url(#h)"
              strokeWidth=".63"
              d="M131.988 300.584c-22.779 8.879-64.751 33.864-85.917 52.666"
              opacity=".6"
            />
            <path
              stroke="#4ade80"
              strokeWidth=".63"
              d="M163.45 288.852c-2.898-5.107-8.435-18.062-7.4-29.032 1.035-10.971 5.382-16.714 6.676-18.319-18.785-2.95-59.563-4.554-91.751 7.141"
            />
            <path
              stroke="url(#j)"
              strokeWidth=".63"
              d="M107 416.714c6.591-10.241 29.106-35.532 39.594-47.111-10.111-8.043-21.594-20.919-26.166-26.424 16.488-13.157 43.654-29.649 55.176-36.25-3.036-3.629-9.579-12.312-11.967-17.624"
            />
            <path
              stroke="#4ade80"
              strokeWidth=".63"
              d="M208.664 423.039c7.109-12.953 20.755-54.004 27.116-72.756-28.112-11.66-48.13-29.228-60.184-43.417"
            />
            <path
              stroke="url(#l)"
              strokeWidth=".63"
              d="M285.525 394.502c-25.576-1.417-50.611-10.222-59.931-14.446 2.452-6.734 7.929-22.109 10.217-29.736"
            />
            <ellipse
              cx="163.449"
              cy="288.951"
              ...
              rx="3"
              ry="2.987"
              transform="rotate(-90 163.449 288.951)"
              filter="url(#glow)"
            />
            <ellipse
              cx="285.522"
              ...
              rx="3"
              ry="2.987"
              transform="rotate(-90 285.522 394.501)"
            />
            <ellipse
              cx="46.072"
              cy="353.25"
              ...
              rx="3"
              ry="2.987"
              transform="rotate(-90 46.072 353.25)"
            />

            <g>
              <path
                d="M 163.449 205 L 163.449 285"
                stroke="#e3e3e3"
                strokeWidth="1"
                fill="none"
              />
          ...
          <defs>
            <filter id="shadow" x="-50%" y="-50%" width="200%" height="200%">
              ...
              <feFlood floodColor="#000000" floodOpacity="0.1" result="flood" />
            ...
            <filter id="innerShadow" x="-50%" y="-50%" width="200%" height="200%">
              ...
              <feOffset in="blur" dx="0" dy="1" result="offsetBlur" />
              <feFlood floodColor="#000000" floodOpacity="0.52" result="shadowColor" />
            ...
            <radialGradient
              ...
              cy="0"
              r="1"
              gradientTransform="rotate(227.429 99.037 139.361)scale(103.192 103.372)"
              gradientUnits="userSpaceOnUse"
            >
              <stop stopColor="#fff" />
            ...
            <radialGradient
              ...
              cy="0"
              r="1"
              gradientTransform="rotate(246.038 108.464 128.218)scale(61.4062 126.439)"
              gradientUnits="userSpaceOnUse"
            >
            ...
            <clipPath id="a">
              <path fill="#fff" d="M0 0h330v430H0z" />
            </clipPath>
            ...
            <mask id="lineMask">
              <rect x="155" y="200" width="20" height="90" fill="url(#fadeMask)" />
            </mask>
            <linearGradient
              id="fadeMask"
              x1="0%"
